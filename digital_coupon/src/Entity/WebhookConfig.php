...
namespace Drupal\digital_coupon\Entity;
 ...
 *   handlers = {
 *     "list_builder" = "Drupal\digital_coupon\WebhookConfigListBuilder",
 *     "form" = {
 *       "add" = "Drupal\digital_coupon\Form\WebhookConfigForm",
 *       "edit" = "Drupal\digital_coupon\Form\WebhookConfigForm",
 *       "delete" = "Drupal\digital_coupon\Form\WebhookConfigDeleteForm"
 *     },
 *     "route_provider" = {
 *       "html" = "Drupal\digital_coupon\WebhookConfigHtmlRouteProvider",
 *     },
 *   },
...
class WebhookConfig extends ConfigEntityBase implements WebhookConfigInterface {
  ...
  /**
   * The Webhook Node Event.
   *
   * @var string
   */
  protected $node_event;

  /**
   * The Webhook Node Type.
   *
   * @var string
   */
  protected $node_type;
  ...
  public function getNodeEvent() {
    $node_event = array_filter($this->node_event);
    return $node_event;
  }
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    $this->node_event = array_filter($this->node_event);
  }
